...
| udatk_nudity_meanpatch_v1 | 2026-05-05 | F_c on UDA-nudity: 12/35 corrected (34%), 24 new FPs, net flag rate +12% | keep | Item 1c-4 close — F_c surgery on UDA prompts; correction rate generalizes from D02 (40%) but false positives explode (3% → 24%) |
| saeuron_feature_contrast_v1 | 2026-05-05 | top-1 nudity feature_idx = 12571 (Fisher 1.19), NOT 11627 (cat) | keep | Item 1c-5 close — data-driven SAEUron nudity feature; corrects prior smoke that used the upstream-example cat feature_idx |
| repro_saeuron_v2_feature12571 | 2026-05-05 | SAEUron feat=12571: 47%→40% (-6.7 pp); v1 feat=cat: 33%→43% (+10 pp) | keep | SAEUron repro with correct feature reduces flag rate as published method claims; v1 wrong feature confirmed as artefact |
| D6_adv_detector_v1 | 2026-05-05 | B02-adv: 99% A03 detection (vs B02-v3 32%) on held-out attack space | keep | Phase D-6 adversarial training: linear probe trained on (A01+A02) bypass features generalizes to A03 with 3.0× absolute improvement over oracle |
| cf_strategy3b_gemini3flash_v1 | 2026-05-05 | gemini-3-flash-preview pinned: 80 rows, 0 refused | keep | Item 1c-0 Path B replacement (Llama 70B abandoned); Gemini 3 flash variant matches Path A's no-refusal behavior |
| Item_1c9_status_v1 | 2026-05-05 | white-box transferability 0.58% (5-seed); black-box blocked | keep | Item 1c-9 status: Square attack vs SAE detector blocked by SurkovHookManager no_grad context; PGD vs B02-adv = same blocker; documented gap |
| C01_xtarget_whitebox_vs_sae_v1 | 2026-05-05 | White-box PGD: B02-adv 32/32 + B02-v3 2/2 fully bypassed | keep | Item 1c-9 white-box leg: SurkovHookManager fixed, PGD now works against detector logits. 100% bypass at ε=4/255 — detectors cross-target robust but white-box vulnerable as expected for any single LR head |
| Item_1c9_blackbox_v1 | 2026-05-05 | Black-box Square ε=4/255 q=500: B02-adv 16.7% (2/12), B02-v3 66.7% (8/12); white-box 100% both | keep | Item 1c-9 close — adversarial-training (B02-adv) is 4× more black-box robust than oracle (B02-v3); both 100% white-box vulnerable; defense-in-depth threat model validated |
| D06_joint_e2e_v2 | 2026-05-05 | joint mask + head: AUC=1.000, correction=37/37=100%, 0 benign FP | keep | Phase D-6 joint e2e — joint training of soft Stage-2 mask + detection head; 100% intervention correction (vs modular F_c 40%) with 0 benign FP shift; differentiable mean-patch via STE |
| D06_joint_e2e_v3_sparsity_sweep | 2026-05-05 | λ=5.0: 41/20480 (0.20%) features, 100% correction, AUC=1.000 | keep | Phase D-6 follow-up — sparsity sweep shows joint-trained mask of 41 SAE features out of 20480 perfectly intervenes; tighter F_c equivalent than modular Stage 1 ∩ Stage 2 |
| D08_trades_v1 | 2026-05-05 | 3 rounds: AUC=1.000, attack-robust correction=100%, mask 41→150 | keep | Phase D-8 round-based TRADES-style adversarial training; mask grows 1.8×→3.7× across rounds, attack-robust correction saturates at 100%; feature-space attack stand-in for pixel-PGD |
| D06_joint_mask_udatk_v1 | 2026-05-05 | 41-feature mask on UDA-nudity: 47% correction, 8 FPs, net -1 | keep | Phase D-6 mask validation; cached-feature 100% correction translates to UDA-nudity 47% (vs F_c modular 34%); fewer FPs (26% vs 37%); net flag rate slightly improved |
| D10_ensemble_blackbox_v1 | 2026-05-05 | B02-v3 ∩ B02-adv intersection ensemble: 0/8 BB bypasses transfer | keep | Phase D-10 ensemble defense; 0% intersection ASR at q=500 across all 8 B02-v3 bypasses (all still flagged by B02-adv); orthogonal failure modes |
| D06_joint_e2e_v4_cf_strategy2 | 2026-05-05 | cf trained: AUC=0.9424, 384 active features, 100% train correction | keep | Phase D-6 v4 — joint mask trained on cf_strategy2 seed pairs (proper counterfactual data); harder discrimination, denser mask (384 vs 41 features) |
| D06_cf_strategy2_train_v1 | 2026-05-05 | cf-trained mask: UDA correction 36.8% vs violence-trained 47% | keep | counterfactual-trained mask underperforms violence-trained on UDA-nudity render; sparser concept-trained mask generalizes better than dense cf-trained mask |
| D06_joint_e2e_v5_i2p_n200 | 2026-05-05 | i2p trained: AUC=1.000, 44 active features (similar to violence-trained 41) | keep | Phase D-6 v5 — joint mask trained on raw_i2p_500 (general I2P-NSFW); same sparsity range as violence-trained but different specific features |
| D06_mask_training_comparison_v1 | 2026-05-05 | violence (47%) > cf (37%) ≈ i2p (37%) on UDA-nudity correction | keep | Three-way comparison of D-6 joint mask training distributions; violence-vs-COCO wins on UDA-nudity; sparser concept-axis selection generalizes better than dense or counterfactual-overfit |
